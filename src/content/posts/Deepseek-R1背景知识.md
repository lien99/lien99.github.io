...
![image-20250411150742270](./Deepseek-R1背景知识.assets/image-20250411150742270.png)
...
![image-20250411154443857](./Deepseek-R1背景知识.assets/image-20250411154443857.png)
...
![image-20250411152902531](./Deepseek-R1背景知识.assets/image-20250411152902531.png)

![image-20250411153000957](./Deepseek-R1背景知识.assets/image-20250411153000957.png)
...
![image-20250411164510491](./Deepseek-R1背景知识.assets/image-20250411164510491.png)



最初的CoT是在prompt中添加few-shot，使得模型模仿这种回复风格进行思考

![image-20250411170028321](./Deepseek-R1背景知识.assets/image-20250411170028321.png)

但是这种方式有一个很大的弊端是针对不同的任务需要人为地设计不同的CoT prompt，这是很繁琐的，所以有了后来的Zero-shot的CoT

![image-20250411170007266](./Deepseek-R1背景知识.assets/image-20250411170007266.png)

但是发现Zero-shot-CoT虽然很简单，但是整体性能是要差一点的，这个时候有人将上述两种方法结合试了一下

![image-20250411170816836](./Deepseek-R1背景知识.assets/image-20250411170816836.png)

后续又有人采用了多数投票的方法增强模型的性能，如下所示：

![image-20250411171433305](./Deepseek-R1背景知识.assets/image-20250411171433305.png)
...
![image-20250411171937651](./Deepseek-R1背景知识.assets/image-20250411171937651.png)

![image-20250411172208907](./Deepseek-R1背景知识.assets/image-20250411172208907.png)
...
![image-20250411173256055](./Deepseek-R1背景知识.assets/image-20250411173256055.png)



reward model可以分为两种形式：

![image-20250411173420445](./Deepseek-R1背景知识.assets/image-20250411173420445.png)
...
![image-20250417144037930](./Deepseek-R1背景知识.assets/image-20250417144037930.png)
...
![image-20250417153500310](./Deepseek-R1背景知识.assets/image-20250417153500310.png)
...
![image-20250417155946517](./Deepseek-R1背景知识.assets/image-20250417155946517.png)

有了这样一个针对每个step标注的数据集，可以训练prm model，类似orm model的训练策略，就可以给定每一个推理步骤都判断是对或错

![image-20250417160234771](./Deepseek-R1背景知识.assets/image-20250417160234771.png)
...
![image-20250417160646896](./Deepseek-R1背景知识.assets/image-20250417160646896.png)
...
![image-20250417161315978](./Deepseek-R1背景知识.assets/image-20250417161315978.png)

这里[deepseek也有一篇文章](https://arxiv.org/pdf/2312.08935)，提出了一种自动获取prm训练过程中每一个step需要的label

![image-20250417162453887](./Deepseek-R1背景知识.assets/image-20250417162453887.png)
